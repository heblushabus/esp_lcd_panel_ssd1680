...
#define SSD1680_PARAM_OUTPUT_CTRL ((uint8_t[]){0x27, 0x01, 0x00}) // 296 MUX
...
#define SSD1680_PARAM_DISP_UPDATE_MODE_1 0xf7 // Full refresh in reference
// Display with DISPLAY Mode 2
#define SSD1680_PARAM_DISP_WITH_MODE_2 0xcf // Legacy/Other
// Partial refresh
#define SSD1680_PARAM_DISP_UPDATE_MODE_PART 0xcc
// Enable clock signal
// Enable Analog
// Display with DISPLAY Mode 2
// Disable Analog
